...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  let contract = await deploy('MERLRewardDistribution', {
    from: deployer,
    log: true,
...
export default func;
func.id = "001_deploy_mERLRewardDistribution"; // id required to prevent reexecution
func.tags = ["MERLRewardDistribution"];
